package com.suraj.user.service.configuration;


import com.suraj.user.service.configuration.interceptor.RestTemplateInterceptor;
...
public class Config {
    ...
    // declrare the beean of Oauth2AuthorizedClient Manager
